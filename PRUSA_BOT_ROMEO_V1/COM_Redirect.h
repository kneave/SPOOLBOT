// Python Script for UDP Com redirect into SerialPlotter using VSPE
/*
ESP32-C3
  |
  |  UDP over Wi-Fi
...
Install VSPE to create virtual COM pair in this case COM30 -> COM31, then run the py script to redirect in both directions
VSPE: https://eterlogic.com/products.vspe.html
SerialPlot: https://github.com/hyOzd/serialplot/releases/tag/v0.13.0

save the script below as udp_bidirectional_com.py
run the python script in command prompt using: py .\udp_bidirectional_com.py
Open COM30 in serialplot

Make sure the IP address of the PC in the main INO file is updated to YOUR address.
*/
...
PRINT_UDP_TEXT = False      # usefull debug switches
